    ...
    <View>
      <ScrollView>
        <View style={styles.content1}>
          <Text style={{ ...FONTS.regular_green }}>
            Nama Penerima: Bunyamin Brian Nathan
          </Text>
          <Text style={{ ...FONTS.regular_green }}>
            Lokasi Penerimaan: Lab RPL
          </Text>
          <TouchableOpacity style={styles.edit}>
            <Text style={{ ...FONTS.bold_white }}>Ubah</Text>
          </TouchableOpacity>
          <View style={styles.section1Child}>
            <Text style={{ ...FONTS.bold_green, fontSize: 18, top: 4 }}>
              Harga Total: Rp.25,000
            </Text>
          </View>
        </View>
        <Text
          style={{ ...FONTS.bold_green, fontSize: 16, marginHorizontal: wp(7) }}
        >
          Menu Breakdown:
        </Text>
        <Cardbd />
